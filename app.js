...
async function initTable(client, callback) {
    await client.query('CREATE TABLE IF NOT EXISTS accounts (id INT PRIMARY KEY, balance INT);', callback);
    await client.query('INSERT INTO accounts (id, balance) VALUES (1, 1000), (2, 250);', callback);
